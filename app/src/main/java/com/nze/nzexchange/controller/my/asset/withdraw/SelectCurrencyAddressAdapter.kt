 ...
 * @创建时间：2018/12/19
 */
class SelectCurrencyAddressAdapter(mContext: Context, var currencyName: String) : NBaseAda<AddressBean, SelectCurrencyAddressAdapter.ViewHolder>(mContext) {
    ...
    override fun initView(vh: ViewHolder, item: AddressBean, position: Int) {
        vh.descTv.text = item.desc
        vh.currencyTv.text = currencyName
