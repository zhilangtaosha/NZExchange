...
class SoketService : Service() {
    ...
    class SoketBinder : Binder(), IWebSoket {
        ...
        fun subscribeDepthAndToday(amount: Int=KLineParam.AMOUNT_DEPTH, depth: String=KLineParam.DEPTH_8, pair: String = mPair){
        ...
        fun subscribeDepth(amount: Int=KLineParam.AMOUNT_DEPTH, depth: String=KLineParam.DEPTH_8, pair: String = mPair) {//订阅深度
