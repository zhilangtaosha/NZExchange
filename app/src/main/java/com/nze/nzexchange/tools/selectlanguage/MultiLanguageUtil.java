package com.nze.nzexchange.tools.selectlanguage;
...
public class MultiLanguageUtil {
    ...
    public String getLanguageName(Context context, int type) {
        String n = mContext.getString(R.string.setting_language_auto);
        switch (type) {
            case LanguageType.LANGUAGE_FOLLOW_SYSTEM: {
                n = mContext.getString(R.string.setting_language_auto);
                break;
            }
            case LanguageType.LANGUAGE_CHINESE_SIMPLIFIED: {
                n = mContext.getString(R.string.setting_simplified_chinese);
                break;
            }
            case LanguageType.LANGUAGE_EN: {
                n = mContext.getString(R.string.setting_language_english);
                break;
            }
        }
        return n;
