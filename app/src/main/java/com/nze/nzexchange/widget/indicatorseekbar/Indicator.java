...
public class Indicator {
    ...
    private void initIndicator() {
        if (mIndicatorType == IndicatorType.CUSTOM) {
            ...
            if (mIndicatorType == IndicatorType.CIRCULAR_BUBBLE) {
                ...
                mIndicatorView = View.inflate(mContext, com.warkiz.widget.R.layout.isb_indicator, null);
                //container
                mTopContentView = (LinearLayout) mIndicatorView.findViewById(com.warkiz.widget.R.id.indicator_container);
                //arrow
                mArrowView = (ArrowView) mIndicatorView.findViewById(com.warkiz.widget.R.id.indicator_arrow);
                mArrowView.setColor(mIndicatorColor);
                //progressText
                mProgressTextView = (TextView) mIndicatorView.findViewById(com.warkiz.widget.R.id.isb_progress);
                mProgressTextView.setText(mSeekBar.getIndicatorTextString());
                mProgressTextView.setTextSize(SizeUtils.px2sp(mContext, mIndicatorTextSize));
                mProgressTextView.setTextColor(mIndicatorTextColor);
    ...
    private GradientDrawable getGradientDrawable() {
        ...
        if (mIndicatorType == IndicatorType.ROUNDED_RECTANGLE) {
            tvDrawable = (GradientDrawable) mContext.getResources().getDrawable(com.warkiz.widget.R.drawable.isb_indicator_rounded_corners);
        } else {
            tvDrawable = (GradientDrawable) mContext.getResources().getDrawable(com.warkiz.widget.R.drawable.isb_indicator_square_corners);
        }
